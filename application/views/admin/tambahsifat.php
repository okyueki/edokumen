            ...
            <div class="card">
              <div class="card-body">
                <h6 class="card-title mb-3"><?php echo $judul;?></h6>
                 <?php echo form_open('sifat/tambahsifat'); ?>
                    <div class="mb-3">
						<label for="exampleInputUsername1" class="form-label">Nama Sifat</label>
						<input type="text" class="form-control" name="nama_sifat" id="exampleInputUsername1" autocomplete="off" placeholder="Nama Sifat">
