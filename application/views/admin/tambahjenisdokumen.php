            ...
            <div class="card">
              <div class="card-body">
                <h6 class="card-title mb-3"><?php echo $judul;?></h6>
                 <?php echo form_open('jenisdokumen/tambahjenisdokumen'); ?>
                    <div class="mb-3">
						<label for="exampleInputUsername1" class="form-label">Jenis Dokumen</label>
						<input type="text" class="form-control" name="jenis_dokumen" id="exampleInputUsername1" autocomplete="off" placeholder="Jenis Dokumen">
                         <small class="form-text text-danger"><?php echo form_error('jenis_dokumen') ?></small>
                    </div>
					<div class="mb-3">
						<label for="exampleInputUsername1" class="form-label">Sifat Dokumen</label>
						 <select class="js-example-basic-single form-select" data-width="100%" name="sifat_dokumen">
